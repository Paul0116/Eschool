...
<head>
  ...
  <title>Asia Tech Bootstrap Template - Index</title>
...
<body>
  ...
  <header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
      ...
      <h1 class="logo me-auto"><a href="index.html">ASIA TECH</a></h1>
      ...
      <a href="/enrollment" class="get-started-btn">Enroll Now</a>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="{{ asset('assets/img/Web-Banner-1.jpg') }}" class="img-fluid" alt="">
          </div>
  ...
  <footer id="footer">
    ...
    <div class="container d-md-flex py-4">
      ...
      <div class="me-md-auto text-center text-md-start">
        <div class="copyright">
          &copy; Copyright <strong><span>Asia Tech</span></strong>. All Rights Reserved
        </div>
